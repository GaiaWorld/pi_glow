...
impl Context {
    ...
    pub unsafe fn compressed_tex_sub_image_2d_jsobj(
        &self,
        target: u32,
        level: i32,
        x_offset: i32,
        ...
        match self.raw {
            RawRenderingContext::WebGl1(ref gl) => gl.compressed_tex_sub_image_2d_with_array_buffer_view(
                target, level, x_offset, y_offset, width, height, format, data,
            ),
            RawRenderingContext::WebGl2(ref gl) => gl.compressed_tex_sub_image_2d_with_array_buffer_view(
                target, level, x_offset, y_offset, width, height, format, data,
            ),
        }
    }

    pub unsafe fn compressed_tex_sub_image_3d_jsobj(
        &self,
        target: u32,
        level: i32,
        x_offset: i32,
        ...
        match self.raw {
            RawRenderingContext::WebGl1(ref _gl) => panic!("Compressed sub image 3D is not supported"),
            RawRenderingContext::WebGl2(ref gl) => gl.compressed_tex_sub_image_3d_with_array_buffer_view(
